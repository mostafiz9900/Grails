...
<html>
    ...
    <body>
        ...
        <div id="show-hello" class="content scaffold-show" role="main">
            ...
            <f:display bean="hello" />
            <g:form resource="${this.hello}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.hello}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
